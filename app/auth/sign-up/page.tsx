    ...
    <div className={cn(
      ...
      <div className="flex justify-between items-center w-full mt-4">
        <div className="w-full flex items-baseline flex-nowrap">
          ...
          <label htmlFor="Remember me" className="ml-2 text-sm text-neutral-600 font-medium">I agree to the Gossamer terms and conditions and the privacy policy</label>
        </div>
      </div>
      <SubmitButton />
      ...
      <p className={cn(
        ...
        "mt-4"
      )}>Have an account? <Link href="/auth/sign-in" className="text-sm text-neutral-800 font-semibold text-nowrap">Sign In</Link></p>
      <p className={cn(
        "text-sm text-neutral-500 leading-6",
        "mt-6 text-center"
      )}>By singing up you agree to our <br /> <Link href="#" className="text-sm text-neutral-800 font-bold text-nowrap">Terms</Link> and <Link href="#" className="text-sm text-neutral-800 font-semibold text-nowrap">Privacy Policy </Link></p>
    </div>
    <div className={cn(
...
const UserFullNameInput = () => {
  return (
    <div className={cn(
        ...
        <input type="text" name="" id="" placeholder="Your full name" className={cn(
