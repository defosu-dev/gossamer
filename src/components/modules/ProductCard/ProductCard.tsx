...
import { hasDiscount, getMinPriceVariant } from '@/lib/utils/price';
...
export function ProductCard({
  ...
  return (
    <div
      className={cn(
        'flex max-w-sm flex-col overflow-hidden rounded-lg bg-white transition-shadow duration-200 hover:shadow-md',
        className
      )}
    >
      <div className="relative p-1">
