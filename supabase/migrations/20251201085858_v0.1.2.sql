-- ==============================================================================
-- GOSSAMER E-COMMERCE MIGRATION (FINAL CONSOLIDATED)
-- Includes: Auth Sync, Slugs, Ratings, Advanced Search, Soft Delete, Addresses
-- ==============================================================================

-- 1️⃣ EXTENSIONS
-- Enable uuid-ossp for UUIDs and pg_trgm for Fuzzy Search
...
-- Junction: Variant <-> Attribute Values
...
create table if not exists public.orders (
    ...
    email text not null, -- Guest identifier
    phone text,
    name text,
    address text, -- Snapshot of address
    total numeric(10,2),
    status public.order_status default 'pending', -- Using Enum
...
-- 1. Handle New User (Auth -> Public Sync)
...
-- 2. Auto-Generate Slug for Products
...
-- 3. Auto-Calculate Product Rating & Reviews Count
...
-- 4. Auto-Update Search Vector (FTS)
...
-- Advanced Search Function (FTS + Trigrams)
